...
### 2.1. Projeto
O projeto visa utilizar dados disponibilizados no site [brasil.io](https://brasil.io/home/) e depois de tratados realizar a confecção de dashboards (Painel visual que apresenta, de maneira centralizada, um conjunto de informações: indicadores e suas métricas).
...
Product Owner | O Product Owner é responsável por maximizar o valor do produto resultante do trabalho da Scrum Team. O Product Owner é também responsável pela gestão eficaz do Product Backlog. | [@Julio-eng](https://github.com/Julio-eng)  
